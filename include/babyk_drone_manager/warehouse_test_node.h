#ifndef WAREHOUSE_TEST_NODE_H
#define WAREHOUSE_TEST_NODE_H
...
class WarehouseTestNode : public rclcpp::Node
{
public:
    WarehouseTestNode();
...
private:
    ...
    std::optional<Eigen::Vector3d> last_assigned_goal_;
    ...
    double lateral_randomness_;       // Randomness for lateral offset
    double random_dir_prob_;          // Probability of exploring in a completely random direction
    double random_node_prob_;         // Probability of picking a completely random known free node
};

#endif // WAREHOUSE_TEST_NODE_H